...
class CustomInstance(BaseModel, AbstractInstanceSource):
    """A single instance for function finding.
    """
    env: EnvironmentConfig
    repo_name: str
    id: str
...
BatchInstanceSourceConfig = InstancesFromHuggingFace | InstancesFromFile | SWEBenchInstances | ExpertInstancesFromFile | CustomInstance
